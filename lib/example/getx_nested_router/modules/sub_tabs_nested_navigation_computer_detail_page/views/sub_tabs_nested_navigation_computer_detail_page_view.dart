...
class SubTabsNestedNavigationComputerDetailPageView
  ...
  const SubTabsNestedNavigationComputerDetailPageView({Key? key, required this.argument}) : super(key: key);
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          OutlinedButton(onPressed: () => Get.back(id: Constants.subTabComputerNavigatorId), child: const Text('Back'))
        ],
      ),
    );
  }
