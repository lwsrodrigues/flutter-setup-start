...
class NestedNavigationDetailView extends GetView<NestedNavigationDetailController> {
  String argument;
  NestedNavigationDetailView({Key? key, required this.argument}) : super(key: key);
